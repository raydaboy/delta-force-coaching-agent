...
#show: report-theme.with(
  title: "Session Workbook & Tactical Playbook",
  author: "Manus AI",
  rhythm: "report",
  running-header: true,
)
...
#page(margin: (top: 30%, x: 2.2cm), numbering: none, header: none)[
  ...
  #align(center)[
    #text(size: 26pt, weight: "bold", fill: report-accent)[Session Workbook & Tactical Playbook]
    #v(0.5em)
    #text(size: 14pt, fill: luma(80))[Private, evidence-first gameplay training document]
    #v(2em)
